     ...
     <div class="container">
          <div class="row">
               <div class="col-md-8 blog-content">
                    <div class="row mb-5">
                         <div class="col-lg-6">
                              <figure><img src="images/img_3.jpg" alt="Image" class="img-fluid">
                                   <figcaption>Paying Bills Online</figcaption>
                              </figure>
                         </div>
                         <div class="col-lg-6">
                              <figure><img src="images/img_4.jpg" alt="Image" class="img-fluid">
                                   <figcaption>Logging In for the First Time</figcaption>
                              </figure>
                         </div>
                    </div>
                    ...
                    <p>Once you've registered, logging in is a breeze:

                         Visit our website and click on the "Log In" button.
                         Enter your username and password.
                         You may be prompted to set up security questions for added protection.
                         Congratulations, you're now logged in and ready to explore!</p>
                    <div class="pt-5">
                         <p>Setting Up Account Alerts: <a href="#">Advanced Features and Tools</a>, <a href="#">Troubleshooting and Support</a> Tags: <a href="#">#Paying Bills Online</a>, <a href="#">#Setting Up Account Alerts</a></p>
                    </div>
